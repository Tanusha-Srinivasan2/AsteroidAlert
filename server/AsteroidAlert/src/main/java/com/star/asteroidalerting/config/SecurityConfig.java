// src/main/java/com/star/asteroidalerting/config/SecurityConfig.java (or notificationservice.config.SecurityConfig.java)
package com.star.asteroidalerting.config; // Adjust package for notificationservice
